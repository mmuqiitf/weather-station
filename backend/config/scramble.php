...
return [
    ...
    'info' => [
        'title' => 'Weather Station Monitoring Platform',
        /*
         * API version.
         */
         ...
         */
        'description' => 'IoT ingestion → validation → storage → aggregation → dashboard. See docs/API.md for F.2 JSON examples (with per-field notes) and F.3 edge-case handling.',
    ],
